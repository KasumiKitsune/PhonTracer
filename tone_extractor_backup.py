...
class PhoneticsApp:
    ...
    def setup_ui(self):
        ...
        ctk.CTkButton(tab_long, text=" 导入字表并切分", image=self.icons.get("cut"), compound="left", command=lambda: self.open_text_dialog('long'), **btn_kwargs_secondary).pack(fill=tk.X, padx=10, pady=(0, 15))
