<div align="center">
  ...
  <p>
    <a href="https://github.com/KasumiKitsune/PhonTracer/releases"><img src="https://img.shields.io/badge/release-v1.2.2-blue.svg" alt="Release"></a>
...
```
> 在 `v1.2.2` 对应代码上，使用 Python 3.12 执行测试：`226 passed, 1 warning`。
